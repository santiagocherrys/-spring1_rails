...
OasRails.configure do |config|
  ...
  config.servers = [{ url: 'https://spring1-rails.onrender.com', description: 'Local' }]

  # Tag Information. For more details follow: https://spec.openapis.org/oas/latest.html#tag-object
  config.tags = [{ name: "Coffee Report", description: "This is the documentation for Api Coffee report for Riwi" }]
